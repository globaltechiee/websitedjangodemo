...
SECRET_KEY = '#=0ltmkei9$k2!!3bga4nsm-u_)y3koha((&n-5mp(&44+mh^^'
...
# We add this because we created a new folder named 'static' inside
# app folder called website in this case 
STATICFILES_DIRS = [
